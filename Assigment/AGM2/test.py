...
if choice_of_print == False:
    ...
    if maze_info.cul_de_sacs == 0:
        ...
        print (
            'The maze has {} sets of accessible cul-de-sacs that are all connected.'.format ( maze_info.cul_de_sacs ) )
    ...
    if maze_info.paths == 0:
        ...
        print (
            'The maze has {} entry-exit paths with no intersections not to cul-de-sacs.'.format ( maze_info.paths ) )
...
if choice_of_print == True:
    ...
    for i in L_drow_row:
        ...
        if L_ways[ i[ 0 ][ 0 ] ][ i[ 0 ][ 1 ] ].dir[ 2 ] == True:
            file.write (
                '    \\draw[dashed, yellow] (' + str ( i[ 0 ][ 1 ] - 0.5 ) + ',' + str ( i[ 0 ][ 0 ] + 0.5 ) + ')' )
        else:
            file.write (
                '    \\draw[dashed, yellow] (' + str ( i[ 0 ][ 1 ] + 0.5 ) + ',' + str ( i[ 0 ][ 0 ] + 0.5 ) + ')' )
