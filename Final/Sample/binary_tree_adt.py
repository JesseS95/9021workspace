...
class BinaryTree:
    ...
    def _evaluate(self, node):
        if node.value.isdigit():
            ...
            opreations = {'+': lambda a, b: a+b,
                            '-': lambda a, b: a-b,
                            '*': lambda a, b: a*b,
                            '/': lambda a, b: a/b}
            left_value = float(self._evaluate(node.left_node))
            right_value = float(self._evaluate(node.right_node))
            op = node.value
            return opreations[op](left_value, right_value)
    ...
    # def evaluate(self):
    #     return self._evaluates(self)
    
    # def _evaluates(self, node):
    ...
    #     sum_of_left = self._evaluates(node.left_node)
    #     sum_of_right = self._evaluates(node.right_node)
    #     return opreations[operators](sum_of_left, sum_of_right)
